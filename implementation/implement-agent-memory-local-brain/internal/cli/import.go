...
but do not stop the import.`,
  ...
  local-brain-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  local-brain-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | local-brain-pp-cli import <resource> --input -`,
