...
large datasets as it has no memory pressure.`,
  ...
  local-brain-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  local-brain-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  local-brain-pp-cli export <resource> --format jsonl | jq '.id'`,
